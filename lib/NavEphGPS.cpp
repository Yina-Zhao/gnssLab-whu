/// @file NavEphGPS.cpp Encapsulates the GPS legacy broadcast ephemeris and clock.
...
Xvt NavEphGPS::svXvt(const CommonTime &t) const {
   ...
   /* if (1)
    {
        cout << "GM: " << ell.gm()<< " A: " << ell.getA() << "  angVelocity: " << ell.angVelocity() << endl;
    }*/
  ...
  //  if (1) cout << "n0: " << n0 << endl;
    ...
    ///Time from ephemeris reference epoch
    double tk = t - ctToe;//todo: 我的解码函数里面没有把这个赋值，我要赋值，我的解码函数里面Toe是周内秒
   // if (1) cout << "t:" <<  t << endl;
  // cout << " ctToe: " << ctToe << endl;//todo: 这里输出是没问题的
