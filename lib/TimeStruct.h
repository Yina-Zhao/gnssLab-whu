//
// Created by shjzhang on 23-12-29.
//
...
public:
    ...
    virtual int Nbits(void) const {return 0;}
    ...
    virtual int bitmask(void) const { return 0;}
    ...
    virtual long MJDEpoch(void) const {return 0;}
...
public:
    ...
    int Nbits(void) const
    {
        static const int n = 13;  // 北斗周数是 13 位
        return n;
    }
    ...
    int bitmask(void) const
    {
        static const int bm = 0x1FFF;  // 13 位掩码，二进制为 1111111111111
        return bm;
    }
    ...
    long MJDEpoch(void) const
    {
        static const long e = BDS_EPOCH_MJD;  // 北斗时间起点对应的修正儒略日
        return e;
    }
